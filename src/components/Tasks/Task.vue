<template>
  <q-item
      ...
      v-ripple>
        ...
        <q-item-section>
          <q-item-label
          :class="{ 'text-strike' : task.completed }" v-html="$options.computed.searchHighlight(task.name, search)"></q-item-label>
        </q-item-section>
        ...
        <q-item-section side top v-if="task.dueDate">
          <div class="row">
            ...
            <div class="column">
              <q-item-label class="row justify-end" caption>{{ niceDate(task.dueDate) }}</q-item-label>
        ...
        <q-item-section side top>
          <div class="row">
            <q-btn @click.stop="showEditTaskModal" dense flat round color="primary" icon="edit" />
            <q-btn @click.stop="prompToDelete(id)" dense flat round color="red" icon="delete" />
          </div>
        </q-item-section>
